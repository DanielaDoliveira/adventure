...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgEditorCallbacks : AssetPostprocessor, ISerializationCallbackReceiver
    {
        ...
        /// </summary>
        public static event Action<Object, string, string> OnAssetMoved;
            ...
            for (int i = 0; i < stream.length; ++i)
            {
                ...
                switch (type)
                {
                    ...
                    case ObjectChangeKind.DestroyGameObjectHierarchy:
                        ...
                        DebugLog("OnGameObjectDestroyed: {0} with parent: {1}", destroyGameObjectHierarchyEvent.instanceId, destroyParentGo.name);
                        break;
                    ...
                    case ObjectChangeKind.ChangeGameObjectParent:
                        ...
                        DebugLog("OnGameObjectParentUpdated: {0} parented to {1} in scene {2} from {3} in scene {4}", gameObjectChanged.name, newParentGo.name, changeGameObjectParent.previousScene.name, previousParentGo.name, changeGameObjectParent.newScene.name);
                        break;
